...
const bestScoreTxt = document.querySelector("#bestScoreTxt");
...
function gameStart() {
  ...
  if(localStorage.getItem('BestScore') === null){
    bestScoreTxt.textContent = `Best Score: 0`
  }else {
    bestScoreTxt.textContent = `Best Score: ${localStorage.getItem('BestScore')}`
  }
